...
import type { ColumnSize, FieldSetProps, FieldSetColumnProps } from '../../types/FieldSet.types';
...
export type {
  ...
  FieldSetProps,
  FieldSetColumnProps,
} from '../../types/FieldSet.types';
export { sizeMapper } from '../../types/FieldSet.types';
